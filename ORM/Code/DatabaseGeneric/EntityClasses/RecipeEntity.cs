...
namespace Recipes-Databse-Code.EntityClasses
{
	...
	
	{
		...
		protected class RecipeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeEntity", InheritanceHierarchyType.None, false, (int)Recipes-Databse-Code.EntityType.RecipeEntity, typeof(RecipeEntity), typeof(RecipeEntityFactory), false);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<RecipeCategoryEntity>>("RecipeCategories", a => a._recipeCategories, (a, b) => a._recipeCategories = b, a => a.RecipeCategories, () => new RecipeRelations().RecipeCategoryEntityUsingRecipeId, typeof(RecipeCategoryEntity), (int)Recipes-Databse-Code.EntityType.RecipeCategoryEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<RecipeIngredientEntity>>("RecipeIngredients", a => a._recipeIngredients, (a, b) => a._recipeIngredients = b, a => a.RecipeIngredients, () => new RecipeRelations().RecipeIngredientEntityUsingRecipeId, typeof(RecipeIngredientEntity), (int)Recipes-Databse-Code.EntityType.RecipeIngredientEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<RecipeInstructionEntity>>("RecipeInstructions", a => a._recipeInstructions, (a, b) => a._recipeInstructions = b, a => a.RecipeInstructions, () => new RecipeRelations().RecipeInstructionEntityUsingRecipeId, typeof(RecipeInstructionEntity), (int)Recipes-Databse-Code.EntityType.RecipeInstructionEntity);
			}
		}
