...
using Recipes-Databse-Code.EntityClasses;
...
namespace Recipes-Databse-Code.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Recipes-Databse-Code.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Recipes-Databse-Code.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", Recipes-Databse-Code.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", Recipes-Databse-Code.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeCategoryEntityFactory() : base("RecipeCategoryEntity", Recipes-Databse-Code.EntityType.RecipeCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeIngredientEntityFactory() : base("RecipeIngredientEntity", Recipes-Databse-Code.EntityType.RecipeIngredientEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeInstructionEntityFactory() : base("RecipeInstructionEntity", Recipes-Databse-Code.EntityType.RecipeInstructionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", Recipes-Databse-Code.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Recipes-Databse-Code.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Recipes-Databse-Code.EntityType)))
			{
				var factory = GetFactory((Recipes-Databse-Code.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Recipes-Databse-Code.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Recipes-Databse-Code.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Recipes-Databse-Code.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case Recipes-Databse-Code.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case Recipes-Databse-Code.EntityType.RecipeCategoryEntity:
					return new RecipeCategoryEntityFactory();
				case Recipes-Databse-Code.EntityType.RecipeIngredientEntity:
					return new RecipeIngredientEntityFactory();
				case Recipes-Databse-Code.EntityType.RecipeInstructionEntity:
					return new RecipeInstructionEntityFactory();
				case Recipes-Databse-Code.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Recipes-Databse-Code.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Recipes-Databse-Code.EntityType)Enum.Parse(typeof(Recipes-Databse-Code.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Recipes-Databse-Code.EntityType)Enum.Parse(typeof(Recipes-Databse-Code.EntityType), leftOperandEntityName, false), joinType, (Recipes-Databse-Code.EntityType)Enum.Parse(typeof(Recipes-Databse-Code.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Recipes-Databse-Code.EntityType)Enum.Parse(typeof(Recipes-Databse-Code.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Recipes-Databse-Code.EntityType)entityTypeValue); }
