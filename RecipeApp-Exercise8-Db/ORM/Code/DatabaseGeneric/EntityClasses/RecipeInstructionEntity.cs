...
namespace RecipeDB.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RecipeInstructionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeInstructionEntity", InheritanceHierarchyType.None, false, (int)RecipeDB.EntityType.RecipeInstructionEntity, typeof(RecipeInstructionEntity), typeof(RecipeInstructionEntityFactory), false);
				AddNavigatorMetaData<RecipeInstructionEntity, RecipeEntity>("Recipe", "RecipeInstructions", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, RecipeDB.RelationClasses.StaticRecipeInstructionRelations.RecipeEntityUsingRecipeIdStatic, ()=>new RecipeInstructionRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)RecipeInstructionFieldIndex.RecipeId }, null, true, (int)RecipeDB.EntityType.RecipeEntity);
			}
		}
		...
		public RecipeInstructionEntity(System.String id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for RecipeInstruction which data should be fetched into this RecipeInstruction object</param>
		/// <param name="validator">The custom validator object for this RecipeInstructionEntity</param>
		public RecipeInstructionEntity(System.String id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "RecipeInstructions"."id".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.String Id
		{
			get { return (System.String)GetValue((int)RecipeInstructionFieldIndex.Id, true); }
		...
		/// <remarks>Mapped on  table field: "RecipeInstructions"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String RecipeId
		{
			get { return (System.String)GetValue((int)RecipeInstructionFieldIndex.RecipeId, true); }
